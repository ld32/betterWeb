...
const HTML = `
<label for="explicit-label-name" style="font-size:20px;">Local AI database (WebGPU) \u2014 index, classify and answer without a server:</label>
<fieldset>
...
<label for="explicit-label-name" style="font-size:20px;">Stored tickets \u2014 review, and delete your uploads:</label>
<fieldset>
